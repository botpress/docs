To customize your Webchat's appearance, use the Theme editor in Botpress Studio. Theme editor can be accessed from your Botpress Workspace, by navigating to Webchat and then clicking on Theme.
