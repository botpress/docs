---
title: Get Started
description: Use the Webchat injection script to add a bot to your website.
---
...
Now that you've added your bot, try [styling it](/inject/styling-your-webchat/) to match the rest of your website's user interface.