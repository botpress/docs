...
<Steps>
  ...
  <Step title="Paste">Paste the code into the body of your HTML file.</Step>
  <Step title="Chat">You're all set! Open your webpage and start chatting with your bot.</Step>
</Steps>
