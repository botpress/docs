...
<ResponseField name="defaultOpen" type="boolean">
  Controls whether the header is expanded by default. Only used when the <code>open</code> prop is uncontrolled.
</ResponseField>
...
<ResponseField name="disabled" type="boolean">
  Disables the header toggle functionality when set to <code>true</code>.
</ResponseField>
...
>
  ...
  links (e.g., website, terms of service), include the following fields: <code>email</code>, <code>phone</code>,{' '}
  <code>privacyPolicy</code>, <code>website</code>, and <code>termsOfService</code>.
</ResponseField>
