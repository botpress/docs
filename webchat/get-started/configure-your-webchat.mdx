...
1. Navigate to the [Dashboard](/get-started/dashboard/) and open your bot's Workspace.
...
- **Message feedback**: Enable/disable message feedback. When enabled, you can view feedback data in the [Analytics](/get-started/dashboard/bot/analytics) tab
