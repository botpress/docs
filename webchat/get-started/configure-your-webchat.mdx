...
2. In the left navigation bar, find the bot you want to configure and select **Webchat**.
...
- Enable/disable message feedback. When enabled, you can view feedback data in the [Analytics](/get-started/dashboard/bot/analytics) tab
