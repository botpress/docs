...
To embed a bot on your WordPress website, you need the bot's Webchat embed code. You can get the embed code from either the [Studio](/guides/studio/interface/introduction) or your [Webchat settings](/webchat/get-started).
