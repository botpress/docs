...
To embed a bot on your Webflow website, you need the bot's Webchat embed code. You can get the embed code from either the [Studio](/learn/reference/introduction) or your [Webchat settings](/learn/get-started/dashboard/).
