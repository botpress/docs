...
To embed a bot on your WordPress website, you need the bot's Webchat embed code. You can get the embed code from either the [Studio](/learn/reference/introduction) or your [Webchat settings](/learn/get-started/dashboard/).
...
<img src="./assets/webflow-inject.png" />
...
Now that you've added your bot, try [styling](/webchat/get-started/styling-your-webchat) it to match the rest of your website's user interface.
