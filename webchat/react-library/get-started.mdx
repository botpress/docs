...
<Note>
  The Webchat React library requires React 18 or higher. Double-check your project's React version to ensure compatibility.
</Note>
...
1. From your bot's Dashboard, select your bot.
2. In the left sidebar, go to **Webchat > Features > Advanced Settings**.
