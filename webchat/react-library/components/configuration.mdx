...
Although you can configure the Botpress Webchat component from your [workspace](https://app.botpress.cloud/workspaces/) the Webchat component library also supports a Configuration object that you can define directly in your code.
