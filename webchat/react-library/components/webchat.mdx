...
<Note>
    The `Webchat` component doesn't use the configuration set in your bot's [Dashboard](/webchat/get-started/configure-your-webchat). Instead, configure it using the [configuration](#configuration) prop.
</Note>
