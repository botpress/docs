...
<ResponseField
    ...
    type="Configuration"
>
    Configuration for Webchat's appearance and style. This object's properties are similar to the Webchat configuration options available in the [Dashboard](/learn/get-started/dashboard/bot/webchat)
