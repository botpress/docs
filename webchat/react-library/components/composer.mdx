...
<Tabs>
    <Tab title="Example">
        <Frame>
        <iframe
            src="http://localhost:6006/iframe.html?args=&globals=&id=composer--primary&viewMode=story"
...
<ResponseField name="connected" type="boolean">
  Indicates whether Eebchat is currently connected. When `false`, a modal appears prompting the user to retry by
  reloading the page.
</ResponseField>
