---
title: Configuration and styling
---

TODO: Make this guide more comprehensive / show where to define and how to import

Although you can configure the [Webchat](/webchat/react-library/components/webchat) component from your [Dashboard](/learn/get-started/dashboard/), the React library also supports a `Configuration` object that you can define directly in your code.
