...
So far, we've only had our bot generate responses using AI. In practice, though, you'll probably run into situations where you want your bot to perform some hard-coded logic.
