...
-   ``: Paste the content of the `` file that was generated when you created your Vonage Application. **_Note: You must replace all line breaks with the character ``_**.
...
3.  Under ``, type the same URLs as you find in your application configuration.
