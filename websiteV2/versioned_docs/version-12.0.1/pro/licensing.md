...
2.  Again in `botpress.config.json` set `http.externalUrl` to the URL of your Botpress installation
3.  Restart your server
4.  Go to admin &gt; My Account &gt; Botpress Licensing Account
...
2.  On the **offline** server, edit `data/global/botpress.config.json` and set `pro.enabled: true`
3.  Again in `botpress.config.json` set `http.externalUrl` to the url of your **offline** server
4.  Restart your **offline** server
5.  Go to `Admin > Server > Server License` and locate your Fingerprint
