...
3.  Once the files are downloaded, place them under the `` folder.
...
Please follow the instructions on the \[GitHub page of Duckling\[()
...
2.  Download the language models of your choice
