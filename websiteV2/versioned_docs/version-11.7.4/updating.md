...
3.  Paste the content into the `/data` folder of the new version
...
2.  Copy the command from Version Control
3.  From your project root, open a terminal and execute the command
