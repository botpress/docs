...
It's open to the public, so you can make contributions to it, share integrations with colleagues or <Tooltip tip="Happy bot building!">bot builders</Tooltip> across the world, and download integrations developed by Botpress and other builders.

Consult the [Botpress Hub documentation](/studio/concepts/card-hub) to learn more.
</Info>
