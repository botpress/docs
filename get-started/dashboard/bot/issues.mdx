...
The information in this tab complements the information found in the [Logs](doc:logs) and the [Events](doc:events) tabs by providing information about persistent, repeatable errors. This includes, for example, errors thrown in execute code cards, but won't diagnose problems like AI hallucinations or inconsistent responses.
