...
To set up integrations you've installed, or to install new integrations, you can navigate to the [integrations menu](/studio/concepts/integrations) found directly in the Studio.
</Note>
