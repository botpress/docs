...
<span>{"A comment was created in Notion"}</span>
  ...
  <ResponseField
    ...
    required
  >
    <span>{"The ID of the Notion workspace"}</span>
  </ResponseField>
  <ResponseField
    name="type"
    type="string"
  ...
  <ResponseField
    ...
    required
  >
    <span>{"The entity that the event is related to"}</span>
  ...
  <ResponseField
    ...
    required
  >
    <span>{"The type of entity (comment)"}</span>
  </ResponseField>
  <ResponseField
    name="id"
    type="string"
    required
  >
    <span>{"The ID of the entity"}</span>
  </ResponseField>
    </Expandable>
  </ResponseField>
  <ResponseField
    ...
    required
  >
    <span>{"Additional data about the event"}</span>
  ...
  <ResponseField
    ...
    required
  >
    <span>{"The ID of the page the comment was created on"}</span>
  </ResponseField>
    </Expandable>
  </ResponseField>
  <ResponseField
    ...
    required
  >
    <span>{"The name of the Notion workspace"}</span>
  </ResponseField>
    </Expandable>
  </ResponseField>
