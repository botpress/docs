...
<Update label="October 17, 2025">
  ...
  - Redesigned the Studio's **Publish** button:
  - Added support for [Claude Haiku 4.5](https://www.anthropic.com/news/claude-haiku-4-5) via the Anthropic integration

  ## Bug Fixes

  - Fixed an issue where clicking Tools in your bot's homescreen would cause a crash if your bot only contained standard Nodes
