...
<Update label="May 23, 2025">
    ## Features & Enhancements
    - The [Fixed Schedule](/guides/studio/interface/triggers#fixed-schedule) Trigger now displays both the timezone and next run:
...
<Update label="May 16, 2025">
    ...
    - Fixed an issue where the [Conversation Started](/guides/studio/interface/triggers#conversation-started) Trigger didn’t work within the shareable Webchat window
