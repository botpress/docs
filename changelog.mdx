...
<Update label="March 6, 2026">
  ...
  - Added a **Triggers** page for managing triggers in ADK agents:
  ...
  - Added an **Evals** page for running declarative conversation tests on ADK agents:
  ...
  - Control Panel theme (dark or light) can be set using `adk theme`
...
<Update label="January 30, 2026">
  ...
  - Raw LLMz output can now be copied when inspecting a message in the emulator
...
<Update label="January 23, 2026">
  ...
  When using the Translator Agent or Summary Agent, additional context can now be provided via an **Additional Context** field:
  ...
  A **Logging Mode** can now be configured in the bot's settings:
...
<Update label="January 16, 2026">
  ...
  - Models from [Mistral AI](https://mistral.ai/) can now be used by installing the official integration
...
<Update label="January 9, 2026">
  ...
  The dashboard now displays which workspace member created a bot:
...
<Update label="December 12, 2025">
  ...
  - Starting with Webchat 3.5, Webchat input is disabled while the bot processes a message
...
<Update label="November 28, 2025">
  ...
  - Added option to automatically recharge a bot's add-ons using **Auto-Recharge**
...
<Update label="October 31, 2025">
  ...
  - Redesigned Conversations tab with Conversation Insights, sentiment analysis and an AI summary:
...
<Update label="October 17, 2025">
  ...
  - Fixed an issue where clicking Tools in the bot's home screen would cause a crash if the bot only contained standard Nodes
...
<Update label="October 3, 2025">
  ...
  - Improved onboarding experience:
    ...
    - Added option to describe the bot's goal when selecting **Other**:
  ...
  <Tabs>
    ...
    - Tasks now run in the background while setting up an agent, making the onboarding experience much faster
  ...
  <Warning>
    ...
    any Webchat deployments on the website that use v1 will stop functioning. To avoid
    service disruption, all users currently using v1 must migrate to Webchat v2 or higher
    before **December 31, 2025**.

    Webchat v1 users should have already received an email with instructions for upgrading. For any questions, contact the support team.
  </Warning>
...
<Update label="September 26, 2025">
  ...
  - Added the option to [override the bot's default LLM settings](/studio/concepts/nodes/autonomous-node#override-default-models) at the Node level
...
<Update label="September 12, 2025">
  ...
  - Improved the variable management experience for Autonomous Nodes:
    ...
    <Frame caption="Read/write access can now be assigned to individual variables as needed.">
      <img
...
- Improved the Card inspector UI, which now appears in the Studio's right panel instead of obstructing the Workflow:
...
- Improved UX for cancelling a subscription:
...
- Any Google Font can now be chosen when styling Webchat:
...
- Analytics can now be viewed for either the current bot or the entire Workspace:
...
<Update label="July 4, 2025">
    ...
    ## Features & enhancements
        ...
        - **New onboarding flow**:
            ...
            When creating a new bot, Studio now has an onboarding flow that automatically builds a production-ready AI agent, styled and tailored to the brand.
            ...
            <Tabs>
                ...
                <Tab title="3. Try out the AI agent">
                    <Frame>
                        <img
                            alt="New agent"
                            className="block dark:hidden"
...
<Update label="June 6, 2025">
    ...
    ## Features & enhancements
        ...
        - Message feedback can now be left in Webchat:
...
<Update label="May 16, 2025">
    ...
    ## Bug fixes
        ...
        - Fixed issue where FAB/avatar images could not be reset to default
...
<Update label="May 9, 2025">
    ...
    ## Features & enhancements
        - **Improvements to Webchat**:
            ...
            - An image can now be added to the Webchat Floating Action Button (FAB)
        - Bot logs can now be filtered by `userId` or `conversationId`
...
<Update label="April 11, 2025">
    ...
    ## Features & enhancements
        ...
        - The storage location of Webchat user/conversation data can now be specified in the Dashboard settings:
