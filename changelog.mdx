...
<Update label="November 7, 2025">
  ...
  - Added option to rename [Execute Code Cards](/learn/reference/cards/execute-code)
  ...
  - Fixed an issue with the [AI Transition](/learn/reference/cards/ai/ai-transition) Card where newly-added fields would be impossible to delete
  - Fixed an issue where the [Capture Information](/learn/reference/cards/capture-information) Card's **Skip if variable is already filled** option wasn't working    properly
    ...
    <Tab title="Just write your prompt...">
      <Frame>
        <img
          alt="Action prompt"
          className="block dark:hidden"
          src="/learn/reference/assets/action-prompt.png"
        />
        <img
          alt="Action prompt"
          className="hidden dark:block"
          src="/learn/reference/assets/action-prompt-dark.png"
        />
      </Frame>
    </Tab>
    <Tab title="then use the generated Action.">
      <Frame>
        <img
          ...
          className="block dark:hidden"
          src="/learn/reference/assets/generated-action.png"
        />
        <img
          alt="Actions"
          className="hidden dark:block"
          src="/learn/reference/assets/generated-action-dark.png"
        />
      </Frame>
    </Tab>
  </Tabs>
...
<Update label="September 26, 2025">
  ...
  - Added the option to [set a specific LLM for Retrieval-Augmented Generation (RAG) tasks](/learn/reference/bot-settings#rag-language-model), like searching a Knowledge Base
  - Added the option to [override your bot's default LLM settings](/learn/reference/nodes/autonomous-node#override-default-models) at the Node level
