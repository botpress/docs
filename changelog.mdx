...
<Update label="March 6, 2026">
  ...
  - Improved UI across **Actions**, **Logs**, and **Traces** pages
  ...
  - **HubSpot**: Added new cards
    - [Get Company](integrations/integration-guides/hubspot)
    - [Update Company](integrations/integration-guides/hubspot)
