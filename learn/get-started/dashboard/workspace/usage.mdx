...
The Table Row section shows the number of rows in the bot's tables and the limit. It accounts for total the number of rows in all of your bot's [Tables](/learn/reference/tables).

<br />

## Vector DB Storage

The Vector Database Storage section shows the maximum storage available for Knowledge Base documents. It accounts for the total number of vectors (condensed pieces of your content) in all of your [Knowledge Base](/learn/reference/knowledge-base/introduction) documents as well as searchable columns in your tables.
