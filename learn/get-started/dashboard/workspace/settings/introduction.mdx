...
Note that deleting a Workspace is an irreversible process, and we're unable to restore the contents of any Workspace that has been deleted.
</Warning>
...
#### I've changed my subscription but the changes don't appear reflected in my dashboard?
...
No, you can can't upgrade a plan or subscription if your payment fails.
