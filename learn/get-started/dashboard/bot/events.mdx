---
title: Events
description: Triggers that your bot recognizes and responds to.
---

Events on Botpress are key triggers that the bot recognizes and reacts to during a conversation.
