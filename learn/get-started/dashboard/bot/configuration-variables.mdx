...
Configuration values set in the Botpress Studio are strictly for testing your bot in the emulator. They don't apply to any production deployments of your bot.
...
In the Studio, navigate to the Variables menu in **Bot Settings**. Here, you can add configuration variables.
...
Save and publish your bot to enable these changes.
