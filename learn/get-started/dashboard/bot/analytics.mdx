...
title: Analytics
description: >-
  Insights into bot performance, user engagement, and conversation
  effectiveness.
---
...
You can visualize data in the analytics tab with the following charts: area, doughnut, bar, pie, metric, spark bar, and spark area.
