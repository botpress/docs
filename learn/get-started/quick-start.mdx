...
This is a sentence with an erore.

This is a sentence I wrote with a warning.

A suggestion should be raised by this sentence.
...
For detailed explanations of any of the concepts introduced on this page, check out our [Dashboard](/learn/get-started/dashboard/workspace/introduction) and [Studio](/learn/reference/introduction) guides.
...
<Columns>
  <Card title="Guides" icon="lightbulb" href="/learn/guides/how-to">
    Follow detailed how-to guides
  </Card>
  <Card title="Reference" icon="book" href="/learn/get-started/dashboard">
