...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        The utility functions that can be used as arguments in user custom code. You can find the NPM [here](https://www.npmjs.com/package/@botpress/sdk), and [API documentation](/api-reference/introduction)
      </td>
    </tr>
