...
If you need advanced analytics about user behavior and the paths they take when interacting with the bot, you can use the [Hooks method](/learn/reference/hooks) to export the data in real-time to a third-party service like Mixpanel, Hotjar, Segment or Amplitude.
