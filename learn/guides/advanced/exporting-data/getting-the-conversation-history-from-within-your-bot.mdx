...
You could add this card to the [Conversation End](/learn/reference/workflows#conversation-end) Workflow so that the full session is sent when the conversation ends. (The bot will only enter the End flow if there's an explicit Transition to an End node)
</Info>
