...
The `event` object is available wherever you can use code in [Botpress Studio](/learn/reference/introduction). This includes:

- [Hooks](/learn/reference/hooks)
- [Actions](/learn/reference/actions)
- [Execute Code Cards](/learn/reference/cards/execute)

You can also access the `event` object within certain [Cards](/learn/reference/cards/introduction)' configuration fields.

<Warning>
    This documentation omits certain properties of the `event` object which exist to maintain internal functionality and aren't useful for bot builders.
</Warning>
