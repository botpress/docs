---
title: Translate your bot's Webchat UI
---
...
<Info>
    ...
    - A [published bot](/learn/quick-start)
    - Knowledge of CSS
    
    For the purposes of this guide, we'll translate the bot's Webchat UI to French. However, you can use the same steps to translate your bot into any language.
</Info>
...
You can translate some elements of the Webchat UI directly from your bot's Webchat settings in the [Dashboard](/guides/dashboard):
...
<Frame>
![Translate name and description](name-and-description.png)
</Frame>
...
<Frame>
![Translate composer placeholder](translate-composer.png)
</Frame>
...
1. Open your bot's Webchat settings in the [Dashboard](/guides/dashboard).
...
<Tip>
    For a full list of Webchat CSS classes, check out our [guide on styling Webchat](/webchat/styling-your-webchat#use-custom-styles).
</Tip>
...
<Frame>
![New conversation modal](new-convo-modal.png)    
</Frame>
