...
Intents are the backbone of understanding in a chatbot. They represent the purpose or goal behind a user's message, allowing the bot to determine the appropriate response. Each intent can have multiple utterances—different ways users might express the same request.
