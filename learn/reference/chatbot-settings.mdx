...
In the **Bot Settings** menu, accessible through the left-hand menu of the Studio, you can adjust general settings that apply to your bot's Workflows and functions.

## Inactivity Timeout

This is the amount of time, in minutes, that your bot will wait for a response before ending the session. When the session ends, your bot will automatically trigger the Timeout Workflow.
