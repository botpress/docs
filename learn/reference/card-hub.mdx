...
From the Hub, you can download and install prebuilt workflows or integrations for use within your bots. The Hub is designed to save time and enhance your development by providing access to workflows and integrations created by Botpress, your team, or other <Tooltip tip="Happy bot building!">bot builders</Tooltip> in the community.
