...
The `Simulate timeout event` button triggers the [Timeout flow](/learn/reference/workflows#timeout) so you can check how the bot behaves when the conversation expires. It's available at the top right corner of the emulator behind the 3 dots.
