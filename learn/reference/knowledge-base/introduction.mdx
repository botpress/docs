...
Information you store in Knowledge Bases counts towards your [Vector DB Storage](/learn/get-started/dashboard/workspace/usage#vector-db-storage), which depends on your [Botpress plan/add-ons](botpress.com/pricing).
