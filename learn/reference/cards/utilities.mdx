...
Use this level to log detailed information about the Workflow execution. It's useful to debug the Workflow and understand how it works.

### Info

Use this level to log general information about the Workflow execution. It's useful to understand the Workflow behavior and the data it's processing.

### Warning

Use this level to log warnings about the Workflow execution. It's useful to alert about potential issues or unexpected behavior.

### Error

Use this level to log errors about the Workflow execution. It's useful to alert about critical issues that need to be fixed.
