...
Flow Logic Cards are essential tools that help control the flow and decision-making within your bot's conversation. They enable you to add logic and structure to your bot’s behavior, making it possible to guide the conversation based on user input, bot state, or external factors.
...
<table>
  ...
  <tr>
    ...
    <td>
      To check a Workflow variable, you can use **`workflow.{variable name}`**<br/>
