...
If the user enters text instead of clicking a button, the AI will search their text for any of the button options, and, if there is an option matching the user's text, it will be handled as if they clicked the button.
</Tip>
