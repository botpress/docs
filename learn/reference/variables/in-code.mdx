...
If you need more flexibility in how you handle information in Botpress Studio, you can use variables in code (for example, in an [Execute Code](/learn/reference/cards/execute) Card).
