...
<Warning>
    ...
    Don't save sensitive information like API keys or passwords in bot variables — use [**configuration variables**](/guides/studio/interface/variables/scopes/configuration) instead.
</Warning>
...
<Frame>
![Bot variable in a text card](/guides/studio/interface/variables/scopes/bot-variable-example.png)
</Frame>