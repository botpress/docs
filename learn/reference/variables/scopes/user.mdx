...
<Note>
    If you don't want your variable to follow the user between conversations, use a different [variable scope](/learn/reference/variables/overview#variable-scopes).
</Note>
