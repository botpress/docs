...
<Note>
Information stored in conversation variables is deleted when the current conversation is over. If you need a variable to persist across multiple conversations, use a different [variable scope](/learn/reference/variables/overview#variable-scopes).
</Note>
