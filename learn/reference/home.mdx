...
Most of the options on the **Home** page are shortcuts to configure your main Workflow's [Autonomous Node](/learn/reference/nodes/autonomous-node). If you don't use an Autonomous Node, you can still configure your bot's [communication channels](#communication-channels) or view a [detailed analysis of your bot's conversations](#conversation-analysis).

## Instructions

<Note>
  The **Instructions** field is only available if you have an [Autonomous Node](/learn/reference/nodes/autonomous-node) in your bot's main Workflow.
</Note>
...
<Note>
  The **Knowledge Base** section is only available if you have an [Autonomous Node](/learn/reference/nodes/autonomous-node) in your bot's main Workflow.
</Note>

You can add [Knowledge Bases](/learn/reference/knowledge-base/) to give your bot sources it can reference when answering questions:
...
<Note>
  The **Tools** section is only available if you have an [Autonomous Node](/learn/reference/nodes/autonomous-node) in your bot's main Workflow.
</Note>
...
<Note>
  The **Learning Experiences** section is only available if you have an [Autonomous Node](/learn/reference/nodes/autonomous-node) in your bot's main Workflow.
</Note>

You can provide feedback on your bot's responses in the [Emulator](/learn/reference/emulator). Then, you can view a summary of your feedback in the **Learning Experiences** section:
