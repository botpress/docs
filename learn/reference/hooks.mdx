...
Hooks let you use custom code with your bot, just like [Actions](/learn/reference/actions) and [Execute Code Cards](/learn/reference/cards/execute-code). The key difference is when the code runs:
