...
- **Variables access**: This section lets you [give your Autonomous Node access to variables](#give-access-to-variables).
...
By default, Autonomous Nodes can't read or update [variables](/learn/reference/variables/overview). If you need to give an Autonomous Node access to a variable:

1. Select the Autonomous Node to open its configuration menu.
2. Under **Variables access**, select **+ Add variable(s)**.
...
<Tip>
  If you don't see the option to **+ Add variable(s)**, make sure you've [created at least one variable](/learn/reference/variables/overview#create-a-variable).
</Tip>

### Override default models

By default, all Autonomous Nodes use the LLMs set in your [Bot Settings](/learn/reference/bot-settings#default-llms). However, you can override these models for individual Autonomous Nodes if needed:
...
3. Enable either:
    ...
    - **Override default RAG model**: Overrides the default LLM used for Retrieval-Augmented Generation (RAG) tasks, like answering questions based on [Knowledge Base](/learn/reference/knowledge-base/introduction) content
...
You can check/change your LLMz version in your [Bot Settings](/learn/reference/bot-settings#llmz-version).
