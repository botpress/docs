...
<Note>
    Want to build your own integration and publish it on Botpress Hub? Check out the [For Developers](/for-developers/sdk/overview) section.
</Note>
...
<p style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
  ...
  <img src="./assets/explore-hub.png" alt="Explore Hub" style={{margin: 0}}/>
  <span>in the upper-right corner of the [Studio](/learn/reference/introduction).</span>
</p>
