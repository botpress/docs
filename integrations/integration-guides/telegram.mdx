...
<Steps>
  ...
  <Step title="Configure the integration in Botpress">
    ...
    1. In the integration's **Bot Token** field, paste your Apify API token.
    2. Select **Save Configuration**.
  </Step>
</Steps>

<Check>
  Your Telegram integration is read—users can now chat with your Botpress bot by messaging your Telegram bot. You can use the integration's [Cards](#cards) to manage the bot's typing indicators.
</Check>
...
You can read [event tags](/learn/guides/advanced/event-properties#param-tags) to get information about an active Telegram conversation:
