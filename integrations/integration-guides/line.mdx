---
title: Line
icon: '/integrations/integration-guides/assets/icons/line.svg'
---
...
import Cards from '/snippets/integrations/cards/botpress/line.mdx'
...
* **File** isn't supported in LINE [Message Types](https://developers.line.biz/en/docs/messaging-api/message-types/)
