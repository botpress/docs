...
2. In the **Timestamp** field, add the message's `ts` property. This is a unique identifer for individual Slack messages — you can retrieve a message's `ts` programmatically using the [Slack API](https://api.slack.com/messaging/retrieving#conversations).
