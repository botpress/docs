...
When sending a file to WhatsApp, the file's name will be changed to whatever is specific in the **Title** field of the [Send Message Card](guides/studio/cards/send-messages#file).
...
<Note>
    You can also set a custom file name by sending the file using an [Execute Code Card](/guides/studio/cards/execute) and specifying a value for the `filename` attribute.
</Note>
