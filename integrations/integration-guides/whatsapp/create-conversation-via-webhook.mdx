---
title: Create a conversation on WhatsApp through webhooks
...
sidebarTitle: Create conversation via webhook
---
...
<Steps titleSize="h3">
  ...
  <Step title="Add the Start Conversation Card">
    Add a Node after the trigger and add the **Start Conversation** Card to it. Configure the Card:
  ...
  <Step title="Store the conversation ID">
