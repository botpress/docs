...
For further information, please check the [WhatsApp documentation](https://developers.facebook.com/docs/whatsapp/cloud-api/reference/media/#download-media) on downloading media files and the [Botpress documentation](/guides/dashboard/bot/configuration-variables) on using Configuration Variables.
...
<img src="./proactive-whatsapp-conversation-workflow.png" />
...
3. **Template Language** *(optional)*: The language code of your WhatsApp message template ([see below](/guides/integrations/integration-guides/whatsapp/introduction#template-language) for more details).
4. **Template Variables JSON** *(optional)*: The values of the variables for your WhatsApp message template, specified as a JSON array representing the list of values ([see below](/guides/integrations/integration-guides/whatsapp/introduction#template-variables) for more details).
...
<img src="./proactive-whatsapp-conversation.png" />
