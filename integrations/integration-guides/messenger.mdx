...
If the bot doesn't answer to some people, that's probably because your app hasn't been reviewed by Meta yet (see [this section](/integrations/integration-guides/instagram#submit-your-app-for-meta-review)). But don't worry, this is not mandatory to test your bot.
</Note>
