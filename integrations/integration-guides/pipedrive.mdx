...
If you run into errors when using the integration's Cards, check out your bot's [Logs](/studio/concepts/debugger-logs-json#logs) and locate the error message:
