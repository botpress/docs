...
*Version: {integrationVersions.notion}*
...
Designed to work in combination with `Get a Database` to guide an [AI task](/learn/reference/cards/ai/ai-task) in generating payloads.
