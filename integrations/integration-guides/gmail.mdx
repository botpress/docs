...
<Tabs>
    ...
    <Tab title="Manual configuration">
        ...
        <Warning>
        The authorization code is only valid for a short period of time. If the code has expired, you will need to repeat the steps outlined in the [Authorize the OAuth application](#authorize-the-oauth-application) section.
        </Warning>
