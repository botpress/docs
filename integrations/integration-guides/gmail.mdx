...
<Tabs>
  ...
  For more advanced use cases, you can manually configure the integration.
    ...
    <Steps>
      <Step>
        Log in to [Google Cloud Console](https://console.cloud.google.com/) with your Gmail account.
      </Step>
      <Step>
    ...
    <Steps>
      ...
      <Step>
        From the topic list, find the topic you created earlier. Then, select the triple-dot <kbd>⋮</kbd> button on the right.
      </Step>
      <Step>
