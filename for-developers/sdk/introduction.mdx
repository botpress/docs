...
Interfaces are contracts that define the expected behavior of integrations. They specify the events and actions that integrations must implement to support specific features or functionalities. This concept is similar to interfaces in many popular general purpose programming languages, such as Java, C#, and TypeScript. Examples include:
...
Plugins are reusable pieces of Bots. They can be used to share functionalities across multiple bots. They can:
