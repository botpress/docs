...
<CardGroup Cols={2}>
    <Card title="Read more" horizontal icon="book" href="/for-developers/sdk/integration/getting-started">
...
<Card title="Getting started" horizontal icon="play" href="/for-developers/sdk/bots-as-code">
