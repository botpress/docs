...
2. [ ] **hub.md**: It should contain an explanation of what the integration is, how to configure it, and how to use it. Please include a link to your git repo if your integration is open source, this drastically increase your chances of getting approved.
