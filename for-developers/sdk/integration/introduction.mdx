...
<Note>While interface creation is currently limited to [Botpress Team plans](https://botpress.com/pricing), integrations can implement any available interface to extend their capabilities.</Note>
