...
<Steps>
  ...
  Now that you have added the <DefinitionReference id="hitl-interface"/> as a dependency, you can run the [`bp add`](/for-developers/sdk/cli-reference#add) command to install it. This command will:
