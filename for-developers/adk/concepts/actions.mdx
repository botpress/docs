...
<Expandable title="Action props">
  ...
  <ResponseField
    ...
    required
  >
    Async function that implements the action logic. Receives validated input matching your input schema and returns validated output matching your output schema.
  </ResponseField>
</Expandable>
