...
<Note>
  Typing indicators are automatically managed when using `execute()`. You only need to manage them manually when sending messages outside of the AI execution.
</Note>
