...
Visit [`http://localhost:3001/`](http://localhost:3001/) to access the interactive [ADK console](/for-developers/adk/console). This gives you an intuitive, visual breakdown of your agent project and lets you [configure its integration's settings](/for-developers/adk/managing-integrations#integration-configuration).
