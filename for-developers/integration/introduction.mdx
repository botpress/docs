...
## Channels
Channels represent elements of the external service where conversations take place between users and bots. A channel might correspond to conversations in a chat application, comment threads in a social media platform, or other communication mediums.
## Actions
