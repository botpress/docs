...
- You can check the status of the file by calling the [Get File](https://botpress.com/docs/api-documentation/#get-file) endpoint and checking that the `file.status` property has changed to "indexing_completed".
