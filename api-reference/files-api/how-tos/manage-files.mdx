...
To get the details of a file you can use the [Get File](https://botpress.com/docs/api-documentation/#get-file) API endpoint.
...
To list all the files of a bot you can use the [List Files](https://botpress.com/docs/api-documentation/#list-files) API endpoint.
...
The [List Files](https://botpress.com/docs/api-documentation/#list-files) API endpoint will return by default the 20 most recent files your bot has. If you need to list older files you can use the `nextToken` property returned in the API response to retrieve the next page (if any) of files. The `nextToken` will be included for each page if there are files remaining to be listed.
