...
<Note>
The Chat API is only available via an integration that comes pre-installed on every bot. Because of this, all users, conversations and messages created using the Chat API belong to the Chat Integration.
