...
All the endpoints of the Runtime API are located behind the `chat` base path. 
...
```bash
npm install @botpress/runtime # for npm
yarn add @botpress/runtime # for yarn
pnpm add @botpress/runtime # for pnpm
```
