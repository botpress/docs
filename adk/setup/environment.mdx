...
<Tip>
  Check out the [CLI reference](fix-before-merge) for full documentation of the `adk secret` command.
</Tip>
...
<Card title="Integrations" icon="boxes" href="/adk/setup/integrations">
