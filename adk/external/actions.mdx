...
Actions are exposed via the Botpress [Runtime API](/api-reference/runtime-api/getting-started)'s [`callAction`](/api-reference/runtime-api/openapi/endpoints/post-v1chatactions) endpoint. External services can call your agent's actions over HTTP:
