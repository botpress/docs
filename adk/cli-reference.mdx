...
| Command | Description |
|---------|-------------|
| `adk integrations add <resource>` | Add an integration or interface (aliases: `i`, `install`) |
...
adk integrations add interface:translator@1.0.0
...
List installed integrations in your project:
