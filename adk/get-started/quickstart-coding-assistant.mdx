...
The assistant loads `botpress-adk-integrations` to find and add Notion, then `botpress-adk` to scaffold the conversation handler. You review and edit each change before it lands.
