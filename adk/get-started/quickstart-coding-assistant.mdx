...
Build an ADK agent alongside Claude Code, Cursor, or Codex. The ADK ships skills that teach these assistants how to work with ADK primitives, so they can scaffold files, add integrations, run evals, and debug issues with the right conventions, without any extra setup from you.
