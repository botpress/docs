...
To search a KB outside of `execute()`, call `search()` on the instance. Useful for custom retrieval, suggested-articles user interfaces, or populating context manually:
