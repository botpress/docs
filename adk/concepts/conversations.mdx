...
<Tip>
The ADK automatically discovers and registers all exported `Conversation` instances in the `src/conversations/` directory. You can use either default or named exports.
</Tip>
