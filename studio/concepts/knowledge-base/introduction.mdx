...
<CardGroup cols={3}>
  <Card
    title="Websites"
    icon="app-window"
    href="/studio/concepts/knowledge-base/add-sources#websites"
    horizontal
  />
  <Card
    title="Documents"
    icon="file-text"
    href="/studio/concepts/knowledge-base/add-sources#documents"
    horizontal
  />
  <Card
    title="Tables"
    icon="table"
    href="/studio/concepts/knowledge-base/add-sources#tables"
    horizontal
  />
  <Card
    title="Search the web"
    icon="search"
    href="/studio/concepts/knowledge-base/add-sources#search-the-web"
    horizontal
  />
  <Card
    title="Rich text"
    icon="type"
    href="/studio/concepts/knowledge-base/add-sources#rich-text"
    horizontal
  />
  <Card
    title="Integrations"
    icon="boxes"
    href="/studio/concepts/knowledge-base/add-sources#sources-from-integrations"
    horizontal
  />
</CardGroup>
...
<Tip>
  Since your bot only references Knowledge Bases when they're needed, they're useful for de-cluttering your [Autonomous Node's prompt](/studio/concepts/nodes/autonomous-node#be-specific).
</Tip>
...
<Warning>
  Both of these Cards require the [Knowledge Agent](/studio/concepts/agents/knowledge-agent) to work properly—make sure it's enabled.
</Warning>
...
Information you store in Knowledge Bases counts towards your [Vector DB Storage](/get-started/dashboard/workspace/usage#vector-db-storage), which depends on your [Botpress plan/add-ons](https://botpress.com/pricing).
