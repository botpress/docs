...
| [Conversations](/get-started/dashboard/bot/conversations) | 90 days | Can be manually deleted using the [Chat API](/api-reference/chat-api/openapi/deleteConversation)|
| [Messages](/get-started/dashboard/bot/conversations) | 90 days | Can be manually deleted using the [Chat API](/api-reference/chat-api/openapi/deleteMessage)|
| [Events](/get-started/dashboard/bot/events) | 90 days | |
