...
You can translate some elements of the Webchat UI directly from your bot's Webchat settings in the [Dashboard](/get-started/dashboard):
...
1. Open your bot's Webchat settings in the [Dashboard](/get-started/dashboard).
