...
Since you need to use the Botpress API to send a reminder to all users, you need to set up a [Personal Access Token](/get-started/dashboard/workspace/user-profile#personal-access-tokens) for authentication.

### Create the token

1. In the bottom-left corner of the [Dashboard](/get-started/dashboard/), select your profile picture.
