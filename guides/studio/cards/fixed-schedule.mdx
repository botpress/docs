...
The **Fixed Schedule** Card lets you trigger some part of your Workflow at a specific time. This is useful if you want to send reminders, notifications, or other time-sensitive messages to users.
...
<Steps titleSize="h3">
    <Step title="Open the Trigger menu">
        ...
        ![Trigger menu](/guides/studio/cards/trigger-menu.png)
    </Step>
    <Step title="Add the Fixed Schedule Card">
        Select **Fixed Schedule** to add the Card:

        ![Fixed Schedule Card](/guides/studio/cards/fixed-schedule.png)
    </Step>
</Steps>
...
![Fixed Schedule Options](/guides/studio/cards/fixed-schedule-options.png)
