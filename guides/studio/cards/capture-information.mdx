...
<table>
  ...
  <tbody>
    <tr>
      <td>
        [SingleChoice](https://botpress.com/docs/capture-information#single-choice)
      </td>
    ...
    <tr>
      <td>
        [MultipleChoice](https://botpress.com/docs/capture-information#multi-choice)
      </td>
    ...
    <tr>
      <td>
        [Boolean](https://botpress.com/docs/capture-information#boolean)
      </td>
    ...
    <tr>
      <td>
        [Confirmation](https://botpress.com/docs/capture-information#confirmation)
      </td>
    ...
    <tr>
      <td>
        [Number](https://botpress.com/docs/capture-information#number)
      </td>
    ...
    <tr>
      <td>
        [EmailAddress](https://botpress.com/docs/capture-information#email-address)
      </td>
    ...
    <tr>
      <td>
        [PhoneNumber](https://botpress.com/docs/capture-information#phone-number)
      </td>
    ...
    <tr>
      <td>
        [FullAddress](https://botpress.com/docs/capture-information#fulladdress)
      </td>
    ...
    <tr>
      <td>
        [RawInput](https://botpress.com/docs/capture-information#raw-input)
      </td>
    ...
    <tr>
      <td>
        [Percentage](https://botpress.com/docs/capture-information#percentage)
      </td>
    ...
    <tr>
      <td>
        [Quantity](https://botpress.com/docs/capture-information#quantity)
      </td>
    ...
    <tr>
      <td>
        [Color](https://botpress.com/docs/capture-information#color)
      </td>
    ...
    <tr>
      <td>
        [TimeMeasurement](https://botpress.com/docs/capture-information#time-measurement)
      </td>
    ...
    <tr>
      <td>
        [WeightMeasurement](https://botpress.com/docs/capture-information#weight-measurement)
      </td>
    ...
    <tr>
      <td>
        [CronSchedule](https://botpress.com/docs/capture-information#cron-schedule)
      </td>
    ...
    <tr>
      <td>
        [OperatingSystem](https://botpress.com/docs/capture-information#operating-system)
      </td>
    ...
    <tr>
      <td>
        [QuantityofPeople](https://botpress.com/docs/capture-information#quantity-of-people)
      </td>
    ...
    <tr>
      <td>
        [VolumeMeasurement](https://botpress.com/docs/capture-information#volume-measurement)
      </td>
    ...
    <tr>
      <td>
        [TemperatureMeasurement](https://botpress.com/docs/capture-information#temperature-measurement)
      </td>
    ...
    <tr>
      <td>
        [Person](https://botpress.com/docs/capture-information#person)
      </td>
    ...
    <tr>
      <td>
        [DateTime](https://botpress.com/docs/capture-information#datetime)
      </td>
