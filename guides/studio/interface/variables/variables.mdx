---
title: Variables
description: Store and reuse information in Botpress Studio.
sidebarTitle: Introduction
---

Variables let you **store information** from somewhere in Botpress Studio and **reuse it somewhere else**. You can use different kinds of variables to store information

Variables are helpful for:

- Making conversations more personalized
- Keeping track of user information
- Connecting to integrations and APIs
