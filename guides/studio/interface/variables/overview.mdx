...
- [Follow a user across all their conversations](/guides/studio/interface/variables/scopes/user) (for example, their name and address)
- [Persist only throughout a single conversation](/guides/studio/interface/variables/scopes/conversation) (for example, items in a virtual cart)
- [Be safely accessible across all your bot's activity](/guides/studio/interface/variables/scopes/configuration) (for example, API tokens and secrets)
...
<CardGroup cols={2}>
  <Card
    ...
    href="/guides/studio/interface/variables/scopes/workflow"
  >
    Only available within the current Workflow
  </Card>
  <Card
    title="User variables"
    href="/guides/studio/interface/variables/scopes/user"
  >
    Available for all conversations with a user
  </Card>
  <Card
    title="Conversation variables"
    href="/guides/studio/interface/variables/scopes/conversation"
  >
    Only available within the current conversation
  </Card>
  <Card
    title="Bot variables"
    href="/guides/studio/interface/variables/scopes/bot"
  >
    Available throughout all your bot's activity
  </Card>
  <Card
    title="Configuration variables"
    href="/guides/studio/interface/variables/scopes/configuration"
  >
...
<Note>
  Configuration variables have a different setup process. Check out the [configuration variables](/guides/studio/interface/variables/scopes/configuration) page for more information.
</Note>
...
<Frame>
![Create a variable](/guides/studio/interface/variables/create-variable.png)
</Frame>
...
Studio will usually indicate where you have the option to assign a value to a variable.. For example, in a [Capture Information](/guides/studio/cards/capture-information) Card:

<Frame>
![Assign a value to a variable](/guides/studio/interface/variables/assign-value.png)
</Frame>

<Tip>
  If you want more control over when and how you assign a value to a variable, you can [use code instead](/guides/studio/interface/variables/in-code).
</Tip>
