...
<Warning>
  ...
  <Accordion title='What are row factors?'>
    ...
    **Example**: If you create a table with a row factor of 3, each row will have a storage limit of 12KB (because 4KB x 3 =  12KB). This will allows make each row will count as 3 rows towards your table's row limit.

    You can check any table's row factor in the bottom-right corner.
  </Accordion>
  </div>
</Warning>
...
Check out the [Table Cards documentation](/guides/studio/cards/execute#table-cards) to learn more about operations with cards.
...
<img src="./table-code-operations.png" />
...
<img src="./computed-column-switch.png" />
...
<img src="./table-dependencies.png" />
