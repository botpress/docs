...
<Frame>
  <img
    ...
    src="/guides/studio/interface/stale-compute-row.jpg"
  />
  <img
    alt="placeholder-alt"
    className="hidden dark:block"
    src="/guides/studio/interface/image-dark.jpg"
  />
</Frame>

<Icon icon="workflow"/> Workflows, or Flows, are **sequences of steps that your bot takes**.

Each Workflow represents a piece of your bot's logic and contains at least one [Node](nodes).

Using Workflows helps you:

- Organize your bot's logic into categories
- Scope data to different parts of your bot's logic
