...
<Note>
This guide is designed to teach a total beginner how to deploy their first bot. If you have more questions and want to get creative with bot-building, check out the [Learn section](/guides/how-to) for detailed how-to guides.
...
Now that you know the basics of Botpress, you can start getting creative. See the [Learn](/guides/how-to) section for guides on how to:
