...
To set up integrations you've installed, or to install new integrations, you can navigate to the [integrations menu](/guides/studio/interface/integrations) found directly in the Studio.
</Note>
