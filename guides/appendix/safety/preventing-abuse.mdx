...
You can watch the [Usage tab](/guides/dashboard/workspace/usage) in the Admin Dashboard to continuously verify the usage of Botpress computational resources by your bot, ensuring that it is operating within the expected limits.
</Info>
