...
Access the API documentation to verify the schema/structure of the [Conversations](/guides/dashboard/bot/conversations) and the [Messages](/guides/dashboard/bot/conversations#message) and see if the data is useful for your use case.
</Note>
