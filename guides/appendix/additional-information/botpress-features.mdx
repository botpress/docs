...
<table align={["left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        The utility functions that can be used as arguments in user custom code. You can find the NPM [here](https://www.npmjs.com/package/@botpress/sdk), and API documentation [here](https://botpress.com/docs/api/)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        [Rebrand the Botpress webchat interface](https://botpress.com/docs/cloud/webchat-customization/overview)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        [Supported content types for each channel](https://botpress.com/docs/cloud/channels/overview/#supported-content-types)
      </td>
    </tr>
