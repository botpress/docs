...
| The maximum number of [Schedule Triggers](/guides/studio/cards/events#fixed-schedule) per bot                                       | 5                           | Bot Recurring Events              |
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- | ---------------------- |
| The maximum time for a bot to process a message or an event before timing out (not the same as [Inactivity Timeout](/guides/studio/interface/chatbot-settings#inactivity-timeout))                        | 60s                         | Invocation Timeout     |
...
| The maximum number of row sizes in a table. However, you can increase it from the factors section from the API ([Read More Here](/guides/studio/interface/tables#create-table))                           | 4kb                         | Table Row Size         |
