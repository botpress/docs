...
If the bot does not answer to some people, that's probably because your app has not been reviewed by Meta yet (see [this section](https://botpress.com/docs/instagram#submit-your-app-for-meta-review)). But don't worry, this is not mandatory to test your bot.
</Note>
