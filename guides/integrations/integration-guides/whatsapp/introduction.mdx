...
For further information, please check the [WhatsApp documentation](https://developers.facebook.com/docs/whatsapp/cloud-api/reference/media/#download-media) on downloading media files and the [Botpress documentation](https://botpress.com/docs/configuration-variables) on using Configuration Variables.
...
3. **Template Language** *(optional)*: The language code of your WhatsApp message template ([see below](https://botpress.com/docs/whatsapp#template-language) for more details).
4. **Template Variables JSON** *(optional)*: The values of the variables for your WhatsApp message template, specified as a JSON array representing the list of values ([see below](https://botpress.com/docs/whatsapp#template-variables) for more details).
